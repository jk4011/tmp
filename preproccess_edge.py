...
parser.add_argument('--img_read_path',type=str,default='/home/wlsgur4011/GCwithCL/ffhq_converted')
parser.add_argument('--mask_save_path',type=str,default='/home/wlsgur4011/GCwithCL/ffhq_converted')
...
if __name__ == '__main__':
    ...
    img_flist = ['%05d.png'%i for i in range(0,69999)]
