...
def config():
    ...
    #training settings
    parser.add_argument('--dataset', type = str,default='ffhq_converted',choices=['ffhq_converted'], help='')
    ...
    #path
    parser.add_argument('--image_path', type=str, default='/home/wlsgur4011/GCwithCL/ffhq_converted')
    parser.add_argument('--edge_path', type=str, default='/home/wlsgur4011/GCwithCL/ffhq_converted')
    ...
    parser.add_argument('--gamma',default=0.3,type=float,help='adversarial loss coefficient.')
